...
[If you want to explore, check out the sitemap!](/sitemap)
...
- [VS Code](https://code.visualstudio.com/) – My trusty code editor. Free, customizable, open source.{% footnoteNum %}{% footnote "Still hate Microsoft, though." %}
...
Find more web dev resources [here](/resources/)!
